...
' Launch localtunnel with static subdomain 'abhilashbabu-workstation'
' (7 = Minimized command window, False = Do not wait for completion)
WshShell.Run "cmd.exe /c npx localtunnel --port 8000 --subdomain abhilashbabu-workstation", 7, False
